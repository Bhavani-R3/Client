    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if(fp !== cp) {
                ...
                await axios.patch(`https://rest-api-0f5q.onrender.com/api/auth/password/update`, {
                    password: fp
                }, {
                    headers: {
                        Authorization: `${token}`
                    ...
                    <div className="card-body">
                        <form autoComplete="off" method='post' onSubmit={submitHandler}>
                            ...
                            <div className="form-group mt-2">
                                ...
                                <input type="password" name="cpass" ref={fcpass} id="cpass" className='form-control' required />
                            </div>
                            <div className="form-group mt-2">
